...
val_dataloader = DataLoader(
    val_dataset, batch_size=configs['batch_size'], shuffle=False, num_workers=0, pin_memory=True, worker_init_fn=seed_worker, generator=g)
test_dataloader = DataLoader(
    test_dataset, batch_size=configs['batch_size'], shuffle=False, num_workers=0, pin_memory=True, worker_init_fn=seed_worker, generator=g)
...
if pretrain:
    ...
    for virtual_node in virtual_nodes:
        ...
        train_loader = torch.utils.data.DataLoader(
            client_train_dataset, batch_size=configs['batch_size'], shuffle=True, num_workers=0, drop_last=True, worker_init_fn=seed_worker, generator=g)
...
for round_idx in range(1, args.max_rounds + 1):
    ...
    for active_idx, active in enumerate(active_nodes):
        ...
        client_train_dataset = torch.utils.data.Subset(train_dataset, idx_tf)
        train_loader = torch.utils.data.DataLoader(
            client_train_dataset, batch_size=configs['batch_size'], shuffle=True, num_workers=0, drop_last=True,
    ...
    for active_idx, active in enumerate(virtual_nodes):
        ...
        client_test_loader = torch.utils.data.DataLoader(
            client_test_dataset, batch_size=args.batch_size, shuffle=True, num_workers=0, drop_last=True, worker_init_fn=seed_worker, generator=g)
